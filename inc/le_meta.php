...
<link rel="stylesheet" href="http://test-catering.housing.berkeley.edu/css/main.css" type="text/css" />
<link rel="stylesheet" href="http://test-catering.housing.berkeley.edu/css/mobile.css" type="text/css" media="screen and (max-device-width: 480px)">
...
/* page arrays */
$main_pages = array("/quform/process.php","/book_event.html","/getting_here/ckc.html","/contact.html","/newsletter.html","/404page.html","/search.html");
...
*/
 ...
 if ($url == $newsletter) 
  ...
  {  /* newsletter */
    ...
    <title>Cal Catering - Your Search Results </title>
    </head>
	<body>
    <?
    }
...
<div class="top_bar_logo">
	<div class="container">
		<div class="mobile_logo_wrap">
        	<img class="mobile_logo" src="http://test-catering.housing.berkeley.edu/img/calcatering_logo.png" />
...
<div class="navbar-wrapper">
 <div class="container">
	<div class="navbar">
     <div class="search"><i class="icon-search icon-white"></i>
    <div class="search_field" align="right">
<script>
  (function() {
    var cx = '005907513008878875572:woxwpcgz7yc';
...
<input type="text" value="" name="EMAIL" class="required email" id="mce-EMAIL" placeholder="Enter Email">
</div>
            ...
            <div id="myCarousel" class="carousel slide">
  			...
  			<!-- Carousel items -->
  				<div class="carousel-inner">
    				...
    				<div class="item"><img src="http://test-catering.housing.berkeley.edu/img/slide/slide2.jpg" /> <div class="carousel-caption">
    				...
    				<div class="active item"><img src="http://test-catering.housing.berkeley.edu/img/slide/slide3.jpg" /> <div class="carousel-caption">
                      <h4>FIND US AND GET IN TOUCH</h4>
                      <p>Ready to plan your next event? Get in touch with a Cal Catering events coordinator today!</p>
